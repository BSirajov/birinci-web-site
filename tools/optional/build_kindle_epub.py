...
Examples:
  ...
  python tools/optional/build_kindle_epub.py --category edalet-ve-cemiyyet
  python tools/optional/build_kindle_epub.py --all
  python tools/optional/build_kindle_epub.py --stems friend-of-god the-blind-well
"""
